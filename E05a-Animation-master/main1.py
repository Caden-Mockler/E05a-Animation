...
#11 establishes the program used to run the program. 
#13 - 15 sets parameters for display and title.

#Creates rules for the ball being displayed and movement
class Ball:
...
class MyGame(arcade.Window):
    ...
    def __init__(self, width, height, title):
        ...
        arcade.set_background_color(arcade.color.ASH_GREY) #Sets background display
