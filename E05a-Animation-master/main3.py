...
class MyGame(arcade.Window):
    ...
    def setup(self):
        ...
        self.player.walk_right_textures.append(arcade.load_texture("images/character0.png",
                                                                   scale=character_scale))
        self.player.walk_right_textures.append(arcade.load_texture("images/character0.png",
                                                                   scale=character_scale))
        self.player.walk_right_textures.append(arcade.load_texture("images/character0.png",
        ...
        self.player.walk_left_textures.append(arcade.load_texture("images/character0.png",
                                                                  scale=character_scale, mirrored=True))
        self.player.walk_left_textures.append(arcade.load_texture("images/character0.png",
                                                                  scale=character_scale, mirrored=True))
        self.player.walk_left_textures.append(arcade.load_texture("images/character0.png",
